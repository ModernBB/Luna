			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-xs-6">
							<p>
								<b><?php echo $lang_back['Headline feature 1 head 1'] ?></b><br />
								<?php echo $lang_back['Headline feature 1 info 1'] ?>
							</p>
						</div>
						<div class="col-xs-6">
							<p>
								<b><?php echo $lang_back['Headline feature 1 head 2'] ?></b><br />
								<?php echo $lang_back['Headline feature 1 info 2'] ?>
							</p>
						</div>
						<div class="col-xs-12">
							<p>
								<b><?php echo $lang_back['Headline feature 1 head 3'] ?></b><br />
								<?php echo $lang_back['Headline feature 1 info 3'] ?>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="thumbnail">
						...
						<p>
							<?php echo $lang_back['Headline feature 2 info'] ?>
						</p>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Second feature 1 head'] ?></b>
								</p>
								<div class="thumbnail">
									<img src="../img/backstage/login.png" width="366" height="318" />
								</div>
								<p>
									<?php echo $lang_back['Second feature 1 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Second feature 2 head'] ?></b>
								</p>
								<div class="thumbnail">
									<img src="../img/backstage/styles.png" width="366" height="318" />
								</div>
								<p>
									<?php echo $lang_back['Second feature 2 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
							<p>
								<b><?php echo $lang_back['Second feature 3 head'] ?></b>
							</p>
							<div class="thumbnail">
								<img src="../img/backstage/database.png" width="366" height="318" />
							</div>
							<p>
								<?php echo $lang_back['Second feature 3 info'] ?>
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Second feature 4 head'] ?></b>
								]<br /><?php echo $lang_back['Second feature 4 info'] ?>
							</p>
						</div>
						<div class="col-xs-4">
							<p>
								<b><?php echo $lang_back['Second feature 5 head'] ?></b>
								<br /><?php echo $lang_back['Second feature 5 info'] ?>
							</p>
						</div>
						<div class="col-xs-4">
							<p>
								<b><?php echo $lang_back['Second feature 6 head'] ?></b>
								<br /><?php echo $lang_back['Second feature 6 info'] ?>
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4">
							<p>
								<b><?php echo $lang_back['Second feature 7 head'] ?>.</b>
								<br /><?php echo $lang_back['Second feature 7 info'] ?>
							</p>
						</div>
						<div class="col-xs-4">
							<p>
								<b><?php echo $lang_back['Second feature 8 head'] ?></b>
								<br /><?php echo $lang_back['Second feature 8 info'] ?>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 1 head'] ?>.</b>
									<br /><?php echo $lang_back['Minor feature 1 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 2 head'] ?></b>
									<br /><?php echo $lang_back['Minor feature 2 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 3 head'] ?></b>
									<br /><?php echo $lang_back['Minor feature 3 info'] ?>
								</p>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 4 head'] ?></b>
									<br /><?php echo $lang_back['Minor feature 4 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 5 head'] ?></b>
									<br /><?php echo $lang_back['Minor feature 5 info'] ?>
								</p>
							</div>
							<div class="col-xs-4">
								<p>
									<b><?php echo $lang_back['Minor feature 6 head'] ?></b>
									<br /><?php echo $lang_back['Minor feature 6 info'] ?>
								</p>
							</div>
						</div>
							<div class="row">
								<div class="col-xs-4">
										<p>
											<b><?php echo $lang_back['Minor feature 7 head'] ?></b>
											<br /><?php echo $lang_back['Minor feature 7 info'] ?>
										</p>
									</div>
									<div class="col-xs-4">
										<p>
											<b><?php echo $lang_back['Minor feature 8 head'] ?></b>
											<br /><?php echo $lang_back['Minor feature 8 info'] ?>
										</p>
									</div>
							</div>
					</div>
