...
if (($luna_user['first_run'] == 0 && $luna_config['o_show_first_run'] == 1 && !$luna_user['is_guest']) ||
	($luna_config['o_first_run_guests'] == 1 && $luna_user['is_guest'])) {
	require FORUM_ROOT.'templates/index-first_run.tpl.php';
}
...
require FORUM_ROOT.'templates/index-forum_board_main.tpl.php';
...
if ($luna_config['o_show_index_stats'] == 1) {
	require FORUM_ROOT.'templates/index-show_index_stats.tpl.php';
}
