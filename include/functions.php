...
function num_users_online()
{
    ...
    $result_num_users = $db->query('SELECT user_id FROM '.$db->prefix.'online WHERE idle=0 AND user_id>1', true) or error('Unable to fetch online list', __FILE__, __LINE__, $db->error());
...
function num_guests_online()
{
    ...
    $result_num_guests = $db->query('SELECT user_id FROM '.$db->prefix.'online WHERE idle=0 AND user_id=1', true) or error('Unable to fetch online list', __FILE__, __LINE__, $db->error());
