...
require FORUM_ROOT.'templates/post-breadcrumb.tpl.php';

// If there are errors, we display them
if (!empty($errors))
{
	require FORUM_ROOT.'templates/post-error.tpl.php';
}
else if (isset($_POST['preview']))
{
	...
	require FORUM_ROOT.'templates/post-preview.tpl.php';
}


$cur_index = 1;

require FORUM_ROOT.'templates/post-form.tpl.php';
...
if ($tid && $luna_config['o_topic_review'] != '0')
{
	...
	require FORUM_ROOT.'templates/post-topic_review.tpl.php';
}
