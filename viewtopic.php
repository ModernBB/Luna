...
require FORUM_ROOT.'templates/viewtopic-main.tpl.php';
...
while ($cur_post = $db->fetch_assoc($result))
{
	...
	require FORUM_ROOT.'templates/viewtopic-topic_row.tpl.php';
}

require FORUM_ROOT.'templates/viewtopic-breadcrumbs.tpl.php';

// Display quick post if enabled
if ($quickpost)
{
	require FORUM_ROOT.'templates/viewtopic-quickpost_form.tpl.php';
}
