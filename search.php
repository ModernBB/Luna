...
if (isset($_GET['action']) || isset($_GET['search_id']))
{
	...
	if (!empty($search_ids))
	{
		...
		require FORUM_ROOT.'templates/search-breadcrumb.tpl.php';

		if ($show_as == 'topics')
		{
			$topic_count = 0;
			require FORUM_ROOT.'templates/search-show_as_topics.tpl.php';
		}
		...
		foreach ($search_set as $cur_search)
		{
			...
			if ($show_as == 'posts')
			{
				...
				require FORUM_ROOT.'templates/search-show_as_post.tpl.php';
			}
			else
			{
				++$topic_count;
				...
				require FORUM_ROOT.'templates/search-show_as_post2.tpl.php';
...
if (!$section || $section == 'simple') {
	...
	require FORUM_ROOT.'templates/search-simple.tpl.php';
	...
	require FORUM_ROOT.'templates/search-advanced.tpl.php';
}
