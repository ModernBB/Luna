...
if ($action == 'change_pass')
{
	...
	require FORUM_ROOT.'templates/profile-change_pass.tpl.php';
}
...
else if ($action == 'change_email')
{
	...
	require FORUM_ROOT.'templates/profile-change_email.tpl.php';
}
...
else if ($action == 'upload_avatar' || $action == 'upload_avatar2')
{
	...
	require FORUM_ROOT.'templates/upload_avatar.tpl.php';
}
...
else if (isset($_POST['delete_user']) || isset($_POST['delete_user_comply']))
{
	...
	require FORUM_ROOT.'templates/profile-delete_user.tpl.php';
}
...
if (!$section || $section == 'view')
{
	...
	require FORUM_ROOT.'templates/profile-view.tpl.php';
...
else if ($section == 'personality')
{
	...
	require FORUM_ROOT.'templates/profile-personality.tpl.php';
...
else if ($section == 'settings')
{
	...
	require FORUM_ROOT.'templates/profile-settings.tpl.php';
}
else if ($section == 'admin')
{
	...
	require FORUM_ROOT.'templates/profile-admin.tpl.php';
}
else
	message($lang['Bad request'], false, '404 Not Found');