...
if (isset($_GET['tid']))
{
	...
	if (isset($_POST['delete_posts']) || isset($_POST['delete_posts_comply']))
	{
		...
		require FORUM_ROOT.'templates/moderate-delete_post.tpl.php';
	}
	else if (isset($_POST['split_posts']) || isset($_POST['split_posts_comply']))
	{
		...
		require FORUM_ROOT.'templates/moderate-split_posts.tpl.php';
	}
	...
	require FORUM_ROOT.'templates/moderate-topic.tpl.php';
}
...
if (isset($_REQUEST['move_topics']) || isset($_POST['move_topics_to']))
{
	...
	require FORUM_ROOT.'templates/moderate-move_topics.tpl.php';
}
...
else if (isset($_POST['merge_topics']) || isset($_POST['merge_topics_comply']))
{
	...
	require FORUM_ROOT.'templates/moderate-merge_topics.tpl.php';
}
...
else if (isset($_POST['delete_topics']) || isset($_POST['delete_topics_comply']))
{
	...
	require FORUM_ROOT.'templates/moderate-delete_topics.tpl.php';
}
...
require FORUM_ROOT.'template/moderate.tpl.php';