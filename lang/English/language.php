...
'WYSIWYG question'				=>	'Why can\'t I see the WYSIWYG editor?',
'WYSIWYG answer'				=>	'You may need to enable JavaScript in order for the editor to work correctly. You can find this under settings in your browser. You could also be using an unsupported browser.',
